import {
  ...
  BackgroundConfig,
  PathData,
} from "@/types/pattern-background";

export const ANIMATION_CONFIG: AnimationConfig = {
  pathsToAnimate: 5,
  animationInterval: 6000, // 6 seconds
...
export const SVG_VIEWBOX = "0 0 4010 2045";
export const ANIMATION_CLASS = "animate-animateSVG";
export const PATTERN_SVG_ID = "pattern-bg";
